...
The complete docs for using the Auth feature of Amplify can be [found here](https://aws-amplify.github.io/docs/js/authentication). We’ve only scratched the surface in this post, so go forth and explore the all of the different features that Amplify has to offer. I’ve found it has a very nice declarative syntax and is very readable for folks who are new to a codebase. For building further on your React-based serverless applications, I highly recommend Stackery for [managing all of your serverless infrastructure](https://www.stackery.io/product/) backed up by seamless, git-based version control.
          ...
          return (
            <Layout title={siteMetadata.title}>
              ...
              <div>
                ...
                <p>
                  Because of my desire to provide a better customer experience and to take matters into my own hands, I began teaching myself how to code and became a software engineer. Currently working on a cloud-based connect, develop and deployment solution for cellular and bluetooth low energy IoT devices at <a href='https://nrfcloud.com/#/' target='_blank' rel='noopener noreferrer'>Nordic Semiconductor</a>.
                </p>
                <p>

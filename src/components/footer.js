  ...
  return (
    <footer>
      ...
      <div>
        ...
        <a style={socialStyle} href='https://dev.to/deeheber' target='_blank' rel='noopener noreferrer' aria-label='linkedin link'><FaDev size={35} /></a>
        <a style={socialStyle} href='https://medium.com/@deeheber' target='_blank' rel='noopener noreferrer' aria-label='linkedin link'><FaMedium size={35} /></a>
